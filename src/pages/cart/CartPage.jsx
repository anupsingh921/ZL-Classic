...
const CartPage = () => {
    ...
    var options = {
            key: "rzp_test_RKJxXjt5YvU8dM",
            key_secret: "CZIWOKs59fwphTjcBahoSk57",
            ...
            <div className="container mx-auto px-4 max-w-7xl lg:px-0 ">
                <div className="mx-auto max-w-2xl py-8 lg:max-w-7xl">
                    ...
                    <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                        <section aria-labelledby="cart-heading" className="rounded-lg bg-orange-50 lg:col-span-8">
                        ...
                        <section
                            ...
                            className="mt-16 rounded-md bg-blue-50 lg:col-span-4 lg:mt-0 lg:p-0"
                        >
                            <h2
                                id="summary-heading"
